...
import { CreditCard, Download, ExternalLink, Calendar, CheckCircle2, XCircle } from 'lucide-react';
      ...
      <div className="space-y-10 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           <div className="md:col-span-2 space-y-6">
              <div className="rounded-3xl border border-neutral-100 bg-white p-8 shadow-sm">
                <div className="flex items-start justify-between">
                  <div>
                    <span className="inline-flex items-center rounded-full bg-emerald-50 px-2.5 py-0.5 text-xs font-bold text-emerald-600 uppercase tracking-tight">Active Plan</span>
                    <h2 className="mt-4 font-display text-2xl font-bold text-neutral-900">Credit Repair Subscription</h2>
                    <p className="text-neutral-500">Your next billing date is May 24, 2026.</p>
                  </div>
                  <div className="text-right">
                    <p className="font-display text-3xl font-bold text-neutral-900">$149</p>
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                   <div className="flex items-center gap-3 p-4 rounded-2xl bg-neutral-50 border border-neutral-100">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-bold text-neutral-900">Chase •••• 1234 (ACH)</p>
                      </div>
                   </div>
                   <div className="flex items-center gap-3 p-4 rounded-2xl bg-neutral-50 border border-neutral-100">
                      <div className="size-10 rounded-xl bg-white flex items-center justify-center text-neutral-900 shadow-sm">
                ...
                <div className="mt-8 flex flex-wrap gap-4 pt-8 border-t border-neutral-100">
                   <button className="rounded-xl bg-neutral-900 px-6 py-2.5 text-sm font-bold text-white transition-all hover:bg-neutral-800">Change Plan</button>
                   <button className="rounded-xl border border-neutral-200 px-6 py-2.5 text-sm font-bold text-neutral-600 transition-all hover:bg-neutral-50 hover:text-neutral-900">Cancel Subscription</button>
                </div>
              </div>
           </div>
           ...
           <div className="space-y-6">
              <div className="rounded-3xl border border-neutral-100 bg-white p-6 shadow-sm">
                <h3 className="font-display text-lg font-bold text-neutral-900 mb-4">Payment Support</h3>
                <p className="text-xs text-neutral-500 leading-relaxed">Service will be automatically paused if an ACH payment fails. Please ensure sufficient funds are available on your billing date.</p>
                <div className="mt-6 flex items-center gap-2 text-xs font-bold text-neutral-900 uppercase tracking-wider">
        ...
        <div className="rounded-3xl border border-neutral-100 bg-white shadow-sm overflow-hidden">
          ...
          <div className="p-4 border-t border-neutral-100 text-center">
             <p className="text-xs text-neutral-400 font-medium tracking-tight">All transactions are secured and encrypted.</p>
          </div>
        </div>
      </div>
    </DashboardLayout>
